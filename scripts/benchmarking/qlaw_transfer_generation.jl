...
using AstroEOMs, AstroUtils, StaticArrays, SPICE
...
function main()
    ...
    @code_warntype generate_qlaw_transfer(qLawPs, nothing)
    #@code_warntype QLawIndirectOptimization.take_integration_step!(qLawPs, mee0, m0, 0.0, 0.0, 10.0, true, nothing)
    #Profile.clear_malloc_data()
    #generate_qlaw_transfer(qLawPs, nothing)
    #QLawIndirectOptimization.take_integration_step!(qLawPs, mee0, m0, 0.0, 0.0, 10.0, true, nothing)

    #cache = QLawIndirectOptimization.QLawTransferCache(qLawPs.oeW, qLawPs.ηr)
    #@btime generate_qlaw_transfer(qLawPs, cache)
