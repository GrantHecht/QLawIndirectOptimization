...
function qLawThrustUnitVector(sma, e, inc, ape, ran, tru, ps::qLawParams)
	...
	t119 = ps.Wp*t108;
	t120 = t119 + 1.0;
	t121 = ps.tMax*t11*t21*t35;
	t125 = b_petro*ps.tMax*sma*t4*t21*t55*t57*t64;
	t122 = t121 - t125;
	t123 = 1.0 / sqrt(t34);
	t124 = 1.0 / (sma*sma);
	t126 = 1.0 / (t122*t122);
	...
	if (u[1] != u[1] || u[2] != u[2] || u[3] != u[3])
		throw(ErrorException("Blow up in the control law."))
    end
