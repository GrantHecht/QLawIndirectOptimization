...
function get_lvlh_to_inertial(mee, ps)
...
function qLawThrust_Keplerian_fast(mee, m, constrained::Bool, ps::qLawParams)
    ...
    RlI = get_lvlh_to_inertial(mee, ps)
    ...
    # Compute acceleration due to control at current state
    at = dir*atMax
